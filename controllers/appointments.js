const { _trusted } = require("mongoose");
...
//@access   Public
exports.getAppointments = async (req, res, _next) => {
  let query;
...
exports.getAppointment = async (req, res, _next) => {
  try {
...
//@access   Private
exports.addAppointment = async (req, res, _next) => {
  try {
...
//@access   Private
exports.updateAppointment = async (req, res, _next) => {
  try {
...
//@access   Private
exports.deleteAppointment = async (req, res, _next) => {
  try {
